...
int main()
{
	...
	bool startSuccess = chattingServer->Start(Data::ServerPort, Data::ServerConcurrentThreadNum,
	...
	if (Data::MonitorActivate)
	{
		...
		bool bActivateMonitorClinent = chattingServer->ActivateMonitorClient(wMonitorServerIp.c_str(), Data::MonitorPort, Data::MonitorClientConcurrentThreadNum, Data::MonitorClientWorkerThreadNum);
