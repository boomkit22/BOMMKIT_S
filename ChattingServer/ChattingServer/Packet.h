...
enum PACKET_TYPE
{
	...
	//
	//------------------------------------------------------------
	PACKET_CS_CHAT_RES_SECTOR_MOVE,
	...
	//
	//------------------------------------------------------------
	PACKET_SS_MONITOR_DATA_UPDATE,


	PACKET_CS_MONITOR = 25000,
	//------------------------------------------------------
	...
	//
	//------------------------------------------------------------
	PACKET_CS_MONITOR_TOOL_REQ_LOGIN,
	...
	//
	//------------------------------------------------------------
	PACKET_CS_MONITOR_TOOL_RES_LOGIN,
	...
	//
	//------------------------------------------------------------
	PACKET_CS_MONITOR_TOOL_DATA_UPDATE,
	...
	dfMONITOR_DATA_TYPE_CHATTING_SERVER_NETWORK_RECV = 45,
	dfMONITOR_DATA_TYPE_CHATTING_SERVER_NETWORK_SEND = 46,
