...
void CNetServer::SendPackets(int64 sessionId, std::vector<CPacket*>& packets)
{
...
inline bool CNetServer::TryReleaseSession(Session* session)
{
...
//이정도도 inline이 되나
// close socket을 1회하기 위해서
inline bool CNetServer::TryReleaseSession(Session* session, int line)
{
	// 목표, 변경할값, 예상값
...
void CNetServer::RegisterGameThread(GameThread* gameThread)
{

}

void CNetServer::RegisterDefaultGameThread(GameThread* gameThread)
{
